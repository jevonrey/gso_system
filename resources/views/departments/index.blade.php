...
{{-- Summary Cards --}}
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
        ...
        <div class="bg-gray-700 shadow rounded-lg p-4 text-center">
            <h3 class="text-lg font-medium text-blue-300">Total Items</h3>
            <p class="text-3xl font-bold text-blue-500">{{ $totalItems }}</p>
        </div>

        {{-- Total Cost --}}
        <div class="bg-gray-700 shadow rounded-lg p-4 text-center">
            <h3 class="text-lg font-medium text-gray-300">Total Cost</h3>
        ...
        {{-- Dropdown Form --}}
            ...
            <label for="location" class="text-gray-300 flex">Select Department:</label>
