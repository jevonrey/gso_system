<x-guest-layout>
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <x-input-error :messages="$errors->get('Pleae Select Role')" class="mt-2" />
        </div>

        <!-- Office -->
        <div class="mt-4">
            <x-input-label for="office" :value="__('Select office')" />

            <x-text-input id="office" class="block mt-1 w-full" type="text" name="office" />

            <x-input-error :messages="$errors->get('Pleae Select Office')" class="mt-2" />
        </div>
