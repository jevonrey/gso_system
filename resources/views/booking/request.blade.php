...
@section('content')
    <div class="container mx-auto px-4 max-w-2xl">
        ...
        <form action="{{ route('booking.store') }}" method="POST" class="space-y-4">
            ...
            <div>
                <label class="block font-medium">Requesting Office or Individual</label>
            ...
            <button type="submit" class="bg-green-600 text-white px-4 py-2 rounded hover:bg-green-700">Submit
                Request</button>
        </form>
    </div>
@endsection
